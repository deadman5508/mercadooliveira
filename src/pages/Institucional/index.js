...
export default function Institucional() {
 return (
   <main className='flex flex-col  mx-auto text-amber-950 sm:max-w-7xl gap-2 mt-5 px-2 mb-52'>
      <div className='flex flex-row w-full gap-2 sm:text-xl '>
            ...
            <p className=' flex indent-5'> O mercado oliveira é uma empresa de produtos alimenticios fundada em 06 de dezembro de 2021,
              por Rosinaldo Santos de Oilveira atual diretor, a empresa é de base familiar 100% Sergipana. 
            </p>
            <p>
