 ...
 return (
   <main  className=' w-full sm:max-w-7xl px-4 py-4'>
        <div className="flex items-center justify-between mx-auto  text-amber-950 ">
          ...
          <Link to='/Produtos'>Conheça nosso mix produtos&raquo;</Link>
        </div>
